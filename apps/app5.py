...
layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            html.H1("Dashboard Q6", style={'textAlign':'center'})
        ], width={'size': 10})
    ]),
...
# SECTION: Visitors Interactions, Incidents, Emergencies
    dbc.Row([
        dbc.Row(children=[html.H2('Interactions, Incidents and Emergencies with Visitors')]),
        dbc.Col([
            dbc.Row([
                dbc.Col([
                    dbc.Card([
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("Notes"),
                            html.H5(id='concluding-remarks', children="Interactions, Incidents and Emergencies with Visitors",
