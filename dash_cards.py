...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            html.H1("Dashboard Q1-Q2", style={'textAlign':'center'})
        ], width={'size': 10})
    ]),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("CPS"),
                            html.H2(id="cps", children="", style={'fontWeight':'bold', 'textAlign':'center'})
                        ])
                    ])
                ], width=4),
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("EMS"),
                            html.H2(id="ems", children="", style={'fontWeight':'bold','textAlign':'center'})
                        ])
                    ])
                ], width=4),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("FIRE"),
                            html.H2(id="fire", children="", style={'fontWeight':'bold', 'textAlign':'center'})
                        ])
                    ])
                ], width=4),
            ], className="mb-3"),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("Emergency"),
                            html.H2(id="emergency", children="", style={'fontWeight':'bold', 'textAlign':'center'})
                        ])
                    ])
                ], width=5),
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("Interaction"),
                            html.H2(id="interaction", children="", style={'fontWeight':'bold','textAlign':'center'})
                        ])
                    ])
                ], width=5),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("Streetscape"),
                            html.H2(id="streetscape", children="", style={'fontWeight':'bold', 'textAlign':'center'})
                        ])
                    ])
                ], width=5),
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("Incident"),
                            html.H2(id="incident", children="", style={'fontWeight':'bold', 'textAlign':'center'})
                        ])
                    ])
                ], width=5),
            ], className="mb-3"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H1(id="total_records", children="", style={'fontWeight':'bold', 'textAlign':'center'})
                        ])
                    ])
                ], width=5),
